...
from .favorites import routes_favorite

# Opcional: podés agruparlos para registro masivo
__all__ = ["routes_category","routes_menu","routes_product","routes_store","routes_image","routes_user","routes_userpoint","routes_donation","routes_favorite"]
