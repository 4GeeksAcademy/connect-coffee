...
const CafeDetail = () => {
  ...
  const cafeData = {
    ...
    reviewsCount: 124,
    description:
      "Ambiente acogedor con especialidad en café de origen y repostería artesanal. Ideal para trabajar o relajarse.",
    location: {
  ...
  const menuData = {
    ...
    Repostería: [
      ...
      },
      {
        ...
        name: "Cheesecake",
        price: 4500,
        description: "Porción de cheesecake de frambuesa",
      },
    ],
    Desayunos: [
      {
        ...
        name: "Tostadas Palta",
        price: 5200,
        description: "Pan integral con palta, tomate y huevo",
      },
      {
        id: 12,
        name: "Sandwich Jamón y Queso",
        price: 4800,
        description: "En pan brioche con jamón artesanal",
      },
      {
        id: 13,
        name: "Bowl Saludable",
        price: 6500,
        description: "Bowl con frutas y granola",
      },
    ],
  };
                  ...
                  <div className="mb-3">
                    <span
                      className={`badge px-3 py-2 ${
                        cafeData.isOpen ? "bg-success" : "bg-danger"
                      }`}
                    >
          ...
          <div className="d-flex gap-2">
            {[
              ...
              <button
                ...
                style={{
                  backgroundColor:
                    activeTab === tab.id ? "#8B4513" : "transparent",
          ...
          <div className="row">
            <div className="col-md-6 mb-4">
              <div className="card border-0 shadow-sm">
                ...
                <div className="card-body">
                  <p className="mb-2">
                    <strong>Dirección:</strong> {cafeData.location.address}
                  </p>
                  <p className="mb-2">
                    <strong>Barrio:</strong> {cafeData.location.neighborhood}
                  </p>
                  <div className="mt-3">
                    <div
